...
knitr::include_graphics("../input/img/knit-button.png", error = FALSE)
```
...
knitr::include_graphics("../input/img/output-options.png", error = FALSE)
``` 
...
<tr class="odd">
<td><code>![Image caption](../input/img/logo.png)</code></td>
<td></td>
<td><img src="../input/img/logo.png" title="fig:" alt="Class logo" /></td>
</tr>
<tr class="even">
...
knitr::include_graphics("../input/img/insert-chunk.png", error = FALSE)
```
...
knitr::include_graphics("../input/img/chunk-toc.png", error = FALSE)
```
...
knitr::include_graphics("../input/img/chunk-options.png", error = FALSE)
```
